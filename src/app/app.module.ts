...
@NgModule({
  declarations: [AppComponent, GetManyComponent, ReturnSummaryComponent, ActivitySummaryComponent, CreateComponent, GetByIdComponent, DeleteComponent, UpdateComponent],
